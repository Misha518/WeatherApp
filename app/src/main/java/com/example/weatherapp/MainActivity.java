...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GetDataFromInternet.AsyncResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=Moscow&appid=3a8f95e944949280bda991558daaf908");
    ...
    private URL buildUrl(String city){
        ...
        String PARAM_CITY = "q";
        String PARAM_APPIID="appid";
        String appid_value = "3a8f95e944949280bda991558daaf908";

        Uri builtUri = Uri.parse(BASE_URL).buildUpon().appendQueryParameter(PARAM_CITY,city).appendQueryParameter(PARAM_APPIID,appid_value).build();
        URL url = null;
        try{
